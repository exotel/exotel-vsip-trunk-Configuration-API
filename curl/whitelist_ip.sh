...
curl --location --request POST "https://${EXO_AUTH_KEY}:${EXO_AUTH_TOKEN}@${EXO_SUBSCRIBIX_DOMAIN}/v2/accounts/${EXO_ACCOUNT_SID}/trunks/${TRUNK_SID}/whitelisted-ips" \
  --header 'Content-Type: application/json' \
  --data-raw "{
  \"ip\": \"${WHITELIST_IP}\",
  \"mask\": ${WHITELIST_MASK:-32}
}" 