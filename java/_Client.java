...
public class _Client {
    ...
    static String get(String path, String query) throws Exception {
        String u = base() + path + (query != null && !query.isEmpty() ? "?" + query : "");
        HttpRequest req = HttpRequest.newBuilder()
            .uri(URI.create(u))
            .timeout(Duration.ofSeconds(30))
            .GET()
    ...
    static String put(String path, String json) throws Exception {
        HttpRequest req = HttpRequest.newBuilder()
            .uri(URI.create(base() + path))
            .header("Content-Type", "application/json")
            .timeout(Duration.ofSeconds(30))
    ...
    static String delete(String path, String query) throws Exception {
        String u = base() + path + (query != null && !query.isEmpty() ? "?" + query : "");
        HttpRequest req = HttpRequest.newBuilder()
            .uri(URI.create(u))
            .timeout(Duration.ofSeconds(30))
