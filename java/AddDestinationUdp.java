public class AddDestinationUdp {
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("Adding UDP destination %s to trunk %s...%n", dest, trunkSid);
        
        String json = String.format("{\"destinations\":[{\"destination\":\"%s\"}]}", dest);
        _Client.post("/trunks/" + trunkSid + "/destination-uris", json);
        
        System.out.println("UDP destination added successfully!");
    }
} 